...
def train():
    ...
    if args.load_transformer:
        ...
        # model.crop_final.load_state_dict(torch.load(os.path.join(args.pretrain_path, 'crop_final.pt')))
        # for param in model.crop_final.parameters():
        #     param.requires_grad = False
...
if __name__=='__main__':
    ...
    parser.add_argument('--load_transformer', action='store_true')
    ...
    if args.use_wandb:
        if args.use_sweep:
            ...
            args.model_save_path = os.path.join(args.model_save_path, 'enformer_pretrain_pool_after_transformer'+str(args.num))
