...
def load_data_pbulk(path, seed, batch_size, num_workers, target_len):
    ...
    perm = torch.randperm(28)
    cell_indice_train = perm[:int(28*0.8)]
    cell_indice_valid = perm[int(28*0.8):]
    seq_indice_train = torch.arange(int(3740*0.8))
    seq_indice_valid = torch.arange(int(3740*0.8), 3740)
